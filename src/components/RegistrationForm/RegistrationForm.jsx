...
const RegistrationForm = () => {
  ...
  return (
    <div className="componentePagina">
      <div
        style={{ width: "300px" }}
        className="container  flex-row align-items-center justify-content-center my-5"
      >
        <Form onSubmit={handleSubmit(onSubmit)}>
          ...
          <Form.Group className="mb-3" controlId="formDomicilio">
            ...
            {errors.domicilio && (
              <span className="text-danger">{errors.domicilio.message}</span>
            )}
          </Form.Group>
